...
mesmo dia, os Vencidos (`templates/vencidos.html`) a terceira, em 24/09, e as Duplicidades (`templates/duplicidades.html`) a quarta, no mesmo dia; as demais ainda vestem o mundo anterior ("A Mesa Limpa", acento
